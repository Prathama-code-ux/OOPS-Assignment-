...
public class Staff {
    ...
    public static void main(String[] args) {
        ...
        itDept.add(new Employee("Alice", 101, "New York", 5000.0));
        itDept.add(new Employee("Bob", 102, "San Francisco", 6000.0));
        itDept.add(new Employee("Charlie", 103, "Chicago", 4500.0));
        itDept.add(new Employee("Diana", 104, "Los Angeles", 7000.0));
        itDept.add(new Employee("Evan", 105, "Seattle", 5500.0));

        double totalSalary = itDept.calcTotalSalary();
        System.out.println("Total annual salary to be paid to all employees: " + totalSalary);
    }
}
